...
<!-- SCREENSHOT: images/collections-list.jpg -- the loaded, alphabetized collections
     checklist with a box checked -->
...
<!-- SCREENSHOT: images/bring-your-own-api-dialog.jpg -- the Bring Your Own API dialog with
     the Name/URL fields and experimental warning banner -->
